...
int16_t AP_MotorsMulticopter::output_to_pwm(float actuator)
{
    ...
    a = get_pwm_output_min();
    b = get_pwm_output_max();


// pwm_min, pwm_max attack
...
*/
    ...
    a = _scv_pwm_min.monitor_SCV(a, _scv_pwm_min._pwm_min);
    b = _scv_pwm_max.monitor_SCV(b, _scv_pwm_max._pwm_max);
...
*/    
    a = _scv_spin_max.monitor_SCV(a, _scv_spin_max._spin_max);
    b = _scv_spin_min.monitor_SCV(b, _scv_spin_min._spin_min);
