...
void AP_MotorsMatrix::output_to_motors()
{
    ...
    _actuator[0] = _scv_actuator_1.monitor_actuator(_actuator[0], _scv_actuator_1._actuator1);
    _actuator[1] = _scv_actuator_2.monitor_actuator(_actuator[1], _scv_actuator_2._actuator2);
    _actuator[2] = _scv_actuator_3.monitor_actuator(_actuator[2], _scv_actuator_3._actuator3);
    _actuator[3] = _scv_actuator_4.monitor_actuator(_actuator[3], _scv_actuator_4._actuator4);

    //std::ofstream tt1("/home/test/log2/actuator.csv", std::ios::out | std::ios::app);
    //tt1 << t_a1 << "," << _actuator[0] <<"," << _actuator[1] <<"," << _actuator[2] <<"," << _actuator[3] <<"\n" ;
...
void AP_MotorsMatrix::output_armed_stabilizing()
{
    ...
    const float compensation_gain2 = get_compensation_gain(); // compensation for battery voltage and altitude
    float compensation_gain;
  
    compensation_gain = compensation_gain2 ;
    compensation_gain = _scv_compensation_gain.monitor_SCV(compensation_gain, _scv_compensation_gain.compensation_gain);
    ...
    //var[_scv_yaw_thrust.yaw_thrust_2] = yaw_thrust;
    ...
    throttle_thrust = _scv_throttle_thrust.monitor_SCV(throttle_thrust, _scv_throttle_thrust.throttle_thrust);

    //var[_scv_throttle_thrust.throttle_thrust_2] = throttle_thrust;
