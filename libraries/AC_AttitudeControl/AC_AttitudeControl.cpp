...
void AC_AttitudeControl::input_euler_angle_roll_pitch_euler_rate_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_rate_cds)
{
    ...
    euler_roll_angle = _scv_euler_roll_angle2.monitor_SCV(euler_roll_angle, _scv_euler_roll_angle2.euler_roll_angle2);
    euler_pitch_angle = _scv_euler_pitch_angle2.monitor_SCV(euler_pitch_angle, _scv_euler_pitch_angle2.euler_pitch_angle2);
    euler_yaw_rate = _scv_euler_yaw_rate2.monitor_SCV(euler_yaw_rate, _scv_euler_yaw_rate2.euler_yaw_rate2);
...
void AC_AttitudeControl::input_euler_angle_roll_pitch_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_angle_cd, bool slew_yaw)
{
    ...
    euler_roll_angle = _scv_euler_roll_angle.monitor_SCV(euler_roll_angle, _scv_euler_roll_angle.euler_roll_angle);
    euler_pitch_angle = _scv_euler_pitch_angle.monitor_SCV(euler_pitch_angle, _scv_euler_pitch_angle.euler_pitch_angle);
    euler_yaw_angle = _scv_euler_yaw_angle.monitor_SCV(euler_yaw_angle, _scv_euler_yaw_angle.euler_yaw_angle);
...
/*
    if (t_a1 > 30000){
        _accel_roll_max = 180000;    // 0 ~ 180000
        _accel_pitch_max = 180000;   // 0 ~ 180000
        _accel_yaw_max = 72000;     // 0 ~72000
        _slew_yaw = 18000;          // 0 ~ 18000
        _input_tc = 1;           // 0 ~ 1
    }
*/
    ...
    if (_rate_bf_ff_enabled) {
        ...
        // zz21 << _attitude_target_euler_angle.x << "," << _attitude_target_euler_angle.y <<"," << _attitude_target_euler_angle.z <<  "\n";
