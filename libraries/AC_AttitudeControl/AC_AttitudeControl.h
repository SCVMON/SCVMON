...
protected:
    ...
    */
    ...
    SR_V _scv_euler_roll_angle;
    SR_V _scv_euler_pitch_angle;
    SR_V _scv_euler_yaw_angle;

    SR_V _scv_euler_roll_angle2;
    SR_V _scv_euler_pitch_angle2;
    SR_V _scv_euler_yaw_rate2;

    SR_V _scv_attitude_target_euler_angle_x;
    SR_V _scv_attitude_target_euler_angle_y;
    SR_V _scv_attitude_target_euler_angle_z;
