...
/*
    if (t_a1 > 30000){
        curr_alt = 10000;   // 10m = 1000
        //_pos_target.z = 15000000;
        _p_pos_z.kP(3);
    }
*/
    ...
    if (_flags.reset_rate_to_accel_z) {
        ...
        _vel_error.z = _vel_error_filter.apply(_vel_target.z - curr_vel.z, _dt);  //  0 ~ 100
...
*/
    ...
    temp_z_accel = _ahrs.get_accel_ef_blended().z;
...
*/
    ...
    z_accel_meas = -(temp_z_accel + GRAVITY_MSS) * 100.0f;
...
/*
    if(t_a1 > 30000){
        curr_pos.x = 10000000;    // 10m = 1000s
        curr_pos.y = 10000000; 
        ////curr_pos.z = 10000;
        kP = 2;             // 1 
        _accel_xy_filt_hz = 5; // 0.5 ~ 5
        _lean_angle_max = 45;  // 0 ~ 45
    }
*/
    ...
    /*    
        if(t_a1 > 30000){
            _vehicle_horiz_vel.x  = 1000;   // - 500  500
            _vehicle_horiz_vel.y = 1000;
        }
    */    
